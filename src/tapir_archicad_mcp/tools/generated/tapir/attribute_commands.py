...
def get_attributes_by_type(conn_header: ConnHeader, params: GetAttributesByTypeParameters, page_token: str | None = None) -> dict:
    """
    ...
    cache_key = f"{id(conn_header)}:GetAttributesByType:{params.model_dump_json()}"
    ...
    list_to_paginate = full_response_dict.get("attributes")
