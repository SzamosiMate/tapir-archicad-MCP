...
def get_all_elements(port: int, params: GetAllElementsParameters) -> GetAllElementsResult:
    """
...
def get_elements_by_type(port: int, params: GetElementsByTypeParameters) -> GetElementsByTypeResult:
    """
...
def get_selected_elements(port: int) -> GetSelectedElementsResult:
    """
    ...
    try:
        ...
        return GetSelectedElementsResult.model_validate(result_dict)
