...
def get_issues(port: int, page_token: str | None = None) -> PaginatedGetIssuesResult:
    ...
    try:
        ...
        cache_key = f"{port}:GetIssues:{params.model_dump_json() if params else ''}"
