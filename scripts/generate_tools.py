...
COMMANDS_TO_EXCLUDE = {
    ...
    "GetRevisionIssuesResult", #Tapir schema has inconsistent DocumentRevision definition
    "SetPropertyValuesOfAttributesParameters", #Tapir schema is missing AttributePropertyValues definition
    "CreateZonesParameters" #Tapir schema has inconsistent Geometry definition
}
